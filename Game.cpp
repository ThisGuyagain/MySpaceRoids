...
{	
	...
	if (m_playerupgrade)
	{
		...
		playerUpgradeText.setPosition(400, 150);
		window->draw(playerUpgradeText);

		sf::Text playerUpgradeText2;
		playerUpgradeText2.setFont(m_mainFont);
		playerUpgradeText2.setString("PRESS 1 TO UPGRADE PRIMARY PRESS 2 TO UPGRADE SECONDARY PRESS 3 TO GAIN A LIFE");
		playerUpgradeText2.setCharacterSize(25);
		playerUpgradeText2.setPosition(400, 260);
